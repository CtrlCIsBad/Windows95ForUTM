...
Pre-installed file: (removed the google drive link since i don't want microsoft to get me a copyright takedown notice from microsoft, check releases)

Pre-configured file: (removed the google drive link since i don't want microsoft to get me a copyright takedown notice from microsoft, check releases)
